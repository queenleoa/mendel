...
import './ZgComputeSmokeTest.css'

// Archived from the original Backtest tab. Not currently routed; kept here
// to wire into the live cycle's gatekeeper LLM call when Phase 2 lands.
const QUESTION = 'What is 2 + 2? Reply with only the integer answer.'

type Meta = { model: string; providerAddress: string }

export default function ZgComputeSmokeTest() {
